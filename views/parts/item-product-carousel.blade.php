<div class="ad-item-wrap" style="background-image: url({{ wncms()->theme()->asset($themeId, 'images/qq-title.jpg') }});">
        ...
        <div id="ad3-swiper" class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a wncms-link-click data-link-id="{{ $link->id }}" href="{{ $link->url }}" target="_blank" class="qq-item">
